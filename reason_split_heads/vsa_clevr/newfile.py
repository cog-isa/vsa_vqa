from vsa import bind, bundle, cyclicsh, ItemMemory
from vsa import generate as hd
import vsa
import json
...
class VSASceneParser:
    ...
    def process_objects_coordinates(self, current_scene):
        ...
        # x_0 = self.im_dict['coordinates'].get_vector('x_coord')
        x_0 = hd()
        x_vec = {}
        shift = 0
        for x in x_coords:
        ...
        # y_0 = self.im_dict['coordinates'].get_vector('y_coord')
        y_0 = hd()
        y_vec = {}
        shift = 0
        for y in y_coords:
        ...
        # z_0 = self.im_dict['coordinates'].get_vector('z_coord')
        z_0 = hd()
        z_vec = {}
        shift = 0
        for z in z_coords:
    ...
    def scene_vector_polar(self, current_scene_objs, scene_im, current_scene):
        ...
        skipped_attributes = ['rotation', 'pixel_coords', 'embedding', '3d_coords']
